...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
    ...
    void initialize_localization()
    {
        ...
        int score_max = compute_score(initial_position.x, initial_position.y, initial_orientation);
        ...
        min_orientation = initial_orientation - (45 * (M_PI / 180));
        max_orientation = initial_orientation + (45 * (M_PI / 180));
        ...
        ROS_INFO("Best score  (%f, %f, %f): score = %i", estimated_position.x, estimated_position.y, estimated_orientation * 180 / M_PI, score_max);
    ...
    void relocalize()
    {
        ...
        int score_max = compute_score(predicted_position.x, predicted_position.y, predicted_orientation);
        ...
        for (float loop_x = min_x; loop_x < max_x; loop_x += 0.05)
        {
            for (float loop_y = min_y; loop_x < max_y; loop_y += 0.05)
            {
                for (float o = min_orientation; o < max_orientation; o += 5 * M_PI / 180)
                {
                    if (cell_value(loop_x, loop_y) == 0)
