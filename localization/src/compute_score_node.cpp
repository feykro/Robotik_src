...
compute_score_node() {
    ...
    sub_scan = n.subscribe("scan", 1, &compute_score_node::scanCallback, this);
    sub_position = n.subscribe("initialpose", 1, &compute_score_node::positionCallback, this);
...
void update() {
    ...
    if ( init_laser && init_position && new_position )
    {
        ...
        new_position = false;
        int score_current = compute_score(initial_position.x, initial_position.y, initial_orientation);
