...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
    void update()
    {
        ...
        //todo: faire en sorte que ça marche avec ça dé-commenté
    ...
    void perform_rotation()
    {
        ...
        //error_rotation = fabs(rotation_to_do - current_orientation);
        ...
        //TODO: indiquer une tolérence à l'erreur ?
        cond_rotation = abs(error_rotation) > rotation_error;
        printf("Cond rotation : %d \n", cond_rotation);
        ...
        if (cond_rotation)
        {
            ...
            //kpr * erreur + kpi * integral + kdr * derivée
    ...
    void perform_translation()
    {
        ...
        cond_translation = (error_translation > translation_error);
    ...
    void combine_rotation_and_translation()
    {
        ...
        float coef_rotation = abs(error_rotation) / rotation_speed_max;// 0 <= coef_rotation <= 1
        if (coef_rotation > 1)
            coef_rotation = 1;
    ...
    void move_robot()
    {
        ...
        cond_goal = (fabs(error_rotation) > rotation_error) || (fabs(error_translation) > translation_error);
